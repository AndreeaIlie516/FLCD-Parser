...
public class RecursiveDescendant {
    ...
    public static void recursiveDescendant(Grammar G, String w) {
        ...
        ModelConfiguration config = new ModelConfiguration(StateType.q, 0, workingStack, inputStack);
